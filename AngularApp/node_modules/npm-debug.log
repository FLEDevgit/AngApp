...
1 verbose cli [ 'node', '/usr/local/bin/npm', 'install', 'passport-local' ]
2 info using npm@1.4.3
3 info using node@v0.10.26
4 error Failed to parse json
4 error Unexpected string
5 error File: /Users/francoislejeune/git/AngApp/AngularApp/package.json
...
8 error command "node" "/usr/local/bin/npm" "install" "passport-local"
9 error cwd /Users/francoislejeune/git/AngApp/AngularApp/node_modules
10 error node -v v0.10.26
11 error npm -v 1.4.3
12 error file /Users/francoislejeune/git/AngApp/AngularApp/package.json
